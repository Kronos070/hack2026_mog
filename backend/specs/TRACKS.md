...
- **Игровой цикл и WebSocket стриминг (Game Core)** — [handoff](handoff-game-core.md) — active, 2026-09-11, next: Сервисный слой GameLoopService + WebSocket эндпоинт тиков

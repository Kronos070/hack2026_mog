...
> **Для AI-агентов и разработчиков:** Данный документ содержит инструкции и команды для поднятия окружения, запуска приложения в режиме разработки, сборки и диагностики бэкенда.  
> 📖 **Человекочитаемая документация по API контрактам:** [**`docs/api/`**](../docs/api/README.md)  
> 📐 **Полная спецификация REST и WebSocket:** [**`API.md`**](./API.md)  
> 🏛 **Архитектурные правила и соглашения по коду:** [**`AGENTS.md`**](./AGENTS.md)
